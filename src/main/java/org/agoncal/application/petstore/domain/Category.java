...
@NamedStoredProcedureQuery(name = "GetCategoryByName", procedureName = "GetCategoryByName", resultClass = Category.class, parameters = {@StoredProcedureParameter(name = "pname", type = String.class, direction = Direction.IN, queryParameter = "pname")})
@XmlRootElement
